 ...
 * consecutive numbers. The number of main cards is equal to the total cards. An
 * ace (card of rank 1) may be treated as the highest possible card or as the
...
public class StraightEvaluator extends AbstractEvaluator
{
	...
	{
		for(int i = 0; i < mainCards.length;)
			break;
