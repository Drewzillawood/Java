...
public class SwingGraphicsExample extends JPanel
{
	...
	/**
	 * Override of the paintComponent method to customize appearance of this
	 * panel. Take a look at the API for the java.awt.Graphics class for other
	 * methods to try.
	 */
	@Override
	...
	/**
	 * Static helper method creates the frame and makes it visible. This method
	 * should always be invoked via a call to SwingUtilities.invokeLater().
	 */
	private static void createAndShow()
	{
		// create the frame, which corresponds to the actual window on the
		// screen
