...
public class PolarAngleComparator implements Comparator<Point> {
	...
	public int compare(Point p1, Point p2) {
		...
		if(crossProduct(p1, p2) == 0 && dotProduct(p1, p1) == dotProduct(p2,p2)) {
			
			return 0;
			
		} else if(p1.equals(referencePoint) || comparePolarAngle(p1, p2) == -1 || (compareDistance(p1, p2) == -1 && crossProduct(p1,p2) == 0)) {
    ...
    public int comparePolarAngle(Point p1, Point p2) {
    	...
    	if(crossProduct(p1, p2) == 0 && p1.getX() != 0 && p1.getY() != 0 || p2.getX() != 0 && p2.getY() != 0 && crossProduct(p1,p2) == 0) {
